...
//To print next Exchange Layer
void RoutingMapTree:: print()
{
    cout<<"Exchanges    ";
    cout<<root->number<<" "<<root->numChildren()<<"\t\t";
    for(int i=0;i<root->numChildren(); i++)
    {
        cout<<root->child(i)->number<<" "<<root->child(i)->numChildren()<<"\t\t";
    }
    cout<<endl;
    cout<<"MobilePhones"<<" ";  //root->m_set.print();
    for(auto i:all_phones.l)
    {
        cout<<i->number<<" ";
    }
    cout<<endl;
...
// //Routing MAp class print + comments
